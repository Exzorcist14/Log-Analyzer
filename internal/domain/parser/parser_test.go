...
const (
	...
	nginxLog = `244.103.237.229 - - [17/Nov/2024:16:07:52 +0000] "GET /reciprocal.hmtl HTTP/1.1"` +
		`200 2420 "-" "Mozilla/5.0 (X11; Linux x86_64)"`
	nonNginxLog = `145.127.201.137 - [17/Nov/2024:12:59:30 +0000] "POST /encompassing.gif HTTP/1.1" 200 806 "-" "Opera/9.52"`
)
